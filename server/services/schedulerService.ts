...
// Core function to publish all due scheduled posts
export const publishScheduledPosts = async (): Promise<number> => {
    try {
        ...
        console.error("Error in scheduler publish cycle:", error);
        throw error;
    }
}
...
export const initScheduler = ()=>{
    if (!process.env.VERCEL) {
        ...
        console.log("Scheduler service initialization skipped (running on Vercel Serverless).");
    }
}