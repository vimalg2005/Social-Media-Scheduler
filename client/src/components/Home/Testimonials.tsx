            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-14">
                    ...
                    <h2 className="font-serif font-medium text-4xl sm:text-5xl leading-tight text-white">
                        Loved by <span className="text-gradient font-semibold">creators &amp; teams</span>
                    </h2>
                    <p className="mt-5 text-slate-400 max-w-md mx-auto">Join thousands of people who automate their social media with SocialAI.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {testimonials.map((t, i) => (
                        <div key={i} className="glass-panel glass-panel-hover p-6 rounded-2xl flex flex-col gap-4 transition-all duration-300">
